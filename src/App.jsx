...
export default function App() {
  ...
  return (
    <div className="app">
      ...
      onToggleItem={handleToggleItem} onClearItems={onClearItems} />
      <Footer />
 ...
 const quantityNum = [...Array(20)].map((_, i) => (
  ...
  return (
    <form className="add-form" onSubmit={handleSubmit}>
        ...
        <select value={quantity} onChange={(e) => setQuantiy(Number(e.
          target.value
        ))}>
          {quantityNum}
        </select>
        <input type="text" placeholder="nama barang..." value={name} onChange={(e) => setName(e.
          target.value)} />
